...
execute as @a at @s if dimension haohan:lunar run attribute @s minecraft:block_break_speed base set 0.8
...
execute as @a at @s unless dimension haohan:lunar run attribute @s minecraft:block_break_speed base resetexecute as @e at @s unless dimension haohan:lunar run attribute @s minecraft:attack_knockback base reeset